...
**Multi-GPU Spot Runners** (5 runners per instance: 3x 2-GPU + 2x 1-GPU):
...
| A100 2-GPU | SM80 | `[self-hosted, linux, x64, gpu, a100, 2gpu]` | p4d.24xlarge | Spot + on-demand fallback |

**Capacity Block Runners** (5 runners per instance: 3x 2-GPU + 2x 1-GPU):

| Type | GPU | `runs-on` Labels | Instance | Pricing |
|------|-----|------------------|----------|---------|
| H100 1-GPU | SM90 | `[self-hosted, linux, x64, gpu, h100, 1gpu]` | p5.48xlarge | Capacity Block |
| H100 2-GPU | SM90 | `[self-hosted, linux, x64, gpu, h100, 2gpu]` | p5.48xlarge | Capacity Block |
| B200 1-GPU | SM100 | `[self-hosted, linux, x64, gpu, b200, 1gpu]` | p6-b200.48xlarge | Capacity Block |
| B200 2-GPU | SM100 | `[self-hosted, linux, x64, gpu, b200, 2gpu]` | p6-b200.48xlarge | Capacity Block |

All multi-GPU nodes run 5 runners: 3x 2-GPU runners (GPUs 0-1, 2-3, 4-5) + 2x 1-GPU runners (GPUs 6, 7).
